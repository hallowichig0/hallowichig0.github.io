...
class PictureProgressive extends Component
{
    public $message;
     ...
     * @return void
     */
    public function __construct($message = null, $width = '', $height = '', $maxwidth = '', $class = 'lazyload', $expand = '', $size = '', $src = '', $srcset = '', $sizes = '', $alt = '')
    {
    ...
    {
        return $this->view('components.picture-progressive');
    }
